...
$cur_sub_tab = $this->uri->segment(2)==''?'dashboard': $this->uri->segment(3);  
?>  
...
<aside class="main-sidebar sidebar-light-primary elevation-4">
  ...
  <a href="<?= base_url('admin/dashboard'); ?>" class="brand-link">
    <img src="<?= base_url($this->general_settings['logo']); ?>" alt="Logo" class="" 
         style="width:220px"> 
  </a>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li id="<?= ($nav['controller_name']) ?>" class="nav-item <?= ($has_submenu) ? 'has-treeview' : '' ?> has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li  id="<?= ($nav['controller_name']) ?>-<?= $sub_nav['link']?>-item"  class="nav-item">
...
<script>
  ...
  $("#<?= $cur_tab ?>-<?= $cur_sub_tab ?>-item > a").addClass('active');
</script>