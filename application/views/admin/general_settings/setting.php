                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="main">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="lat" placeholder="currency"
                            value="<?php echo html_escape($general_settings['default_lat']); ?>">
                        </div>

                        <div class="form-group">
                            <label class="control-label">Lang</label>
                            <input type="text" class="form-control" name="lang" placeholder="currency"
                            value="<?php echo html_escape($general_settings['default_lang']); ?>">
                        </div>
                       <div class="form-group">
