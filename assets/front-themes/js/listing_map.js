	var base_url = 'https://gis.lampungtech.com/';
	(function(A) {
	if (!Array.prototype.forEach)
		...
		markersData = {
			'Marker': [
			{
				...
				map_image_url: base_url+'assets/front-themes/img/thumb_map_single_hotel.jpg',
				rate: 'Superb | 7.5',
			...
			for (var key in markersData)
				markersData[key].forEach(function (item) {
					marker = new google.maps.Marker({
						...
						map: mapObject,
						icon: base_url+'assets/front-themes/img/pins/' + key + '.png',
					});
	...
	new MarkerClusterer(mapObject, markers[key]);
		...
		function getInfoBox(item) {
			return new InfoBox({
				...
				closeBoxMargin: '',
				closeBoxURL: base_url+"assets/front-themes/img/close_infobox.png",
				isHidden: false,
				alignBottom: true,
				pane: 'floatPane',
